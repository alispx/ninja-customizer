 ...
 */
!function(n){"use strict";function t(n){window.console&&window.console.log&&console.log(n)}function e(t,e){return"#"==e[0]&&e.indexOf(" ")<0?n(e):t.find(e)}function o(n,t,e){this.init(n,t,e)}function i(){this.rules=[]}n.extend(o.prototype,{init:function(n,t,e){this.controller=n,this.condition=t,this.value=e,this.rules=[],this.controls=[]},evalCondition:function(t,e,o,i,r){if("=="==this.condition)return i==r;if("!="==o)return i!=r;if("()"==o)return i(t,e,r);if("any"==o)return n.inArray(r,i)>-1;if("not-any"==o)return-1==n.inArray(r,i);throw new Error("Unknown condition:"+o)},checkCondition:function(n,e){if(!this.condition)return!0;var o=n.find(this.controller);0===o.size()&&e.log&&t("Evaling condition: Could not find controller input "+this.controller);var i=this.getControlValue(n,o);return e.log&&void 0===i&&t("Evaling condition: Could not exctract value from input "+this.controller),void 0===i?!1:(i=this.normalizeValue(o,this.value,i),this.evalCondition(n,o,this.condition,this.value,i))},normalizeValue:function(n,t,e){return"number"==typeof t?parseFloat(e):e},getControlValue:function(n,t){if("radio"==t.attr("type")&&t.size()>1){var e=t.filter(":checked").val();return e}return"checkbox"==t.attr("type")||"radio"==t.attr("type")?t.is(":checked"):t.val()},createRule:function(n,t,e){var i=new o(n,t,e);return this.rules.push(i),i},include:function(n){if(!n)throw new Error("Must give an input selector");this.controls.push(n)},applyRule:function(e,o,i){var r;r=void 0===i?this.checkCondition(e,o):i,o.log&&t("Applying rule on "+this.controller+"=="+this.value+" enforced:"+i+" result:"+r),o.log&&!this.controls.length&&t("Zero length controls slipped through");var l=o.show||function(n){n.show()},s=o.hide||function(n){n.hide()},c=n.map(this.controls,function(n){var i=e.find(n);return o.log&&0===i.size()&&t("Could not find element:"+n),i});r?(n(c).each(function(){o.log&&0===n(this).size()&&(t("Control selection is empty when showing"),t(this)),l(this)}),n(this.rules).each(function(){this.applyRule(e,o)})):(n(c).each(function(){o.log&&0===n(this).size()&&(t("Control selection is empty when hiding:"),t(this)),s(this)}),n(this.rules).each(function(){this.applyRule(e,o,!1)}))}}),n.extend(i.prototype,{createRule:function(n,t,e){var i=new o(n,t,e);return this.rules.push(i),i},applyRules:function(n,e){var o;for(e=e||{},e.log&&t("Starting evaluation ruleset of "+this.rules.length+" rules"),o=0;o<this.rules.length;o++)this.rules[o].applyRule(n,e)},walk:function(){function t(o){e.push(o),n(o.children).each(function(){t(this)})}var e=[];return n(this.rules).each(function(){t(this)}),e},checkTargets:function(o,i){var r=0,l=this.walk();n(l).each(function(){if(0===o.find(this.controller).size())throw new Error("Rule's controller does not exist:"+this.controller);if(0===this.controls.length)throw new Error("Rule has no controls:"+this);n(this.controls).each(function(){if(0===e(o,this))throw new Error("Rule's target control "+this+" does not exist in context "+o.get(0));r++})}),i.log&&t("Controller check ok, rules count "+l.length+" controls count "+r)},install:function(t){n.deps.enable(n(document.body),this,t)}});var r={createRuleset:function(){return new i},enable:function(n,e,o){o=o||{},(o.checkTargets||void 0===o.checkTargets)&&e.checkTargets(n,o);o.log&&t("Enabling dependency change monitoring on "+n.get(0));var i=function(){e.applyRules(n,o)},r=n.on?n.on("change.deps",null,null,i):n.live("change.deps",i);return e.applyRules(n,o),r}};n.deps=r}(jQuery);